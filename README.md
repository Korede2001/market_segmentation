...
From above, we see a right skew in the annual income even within this zoomed in range, confirming that the trend is quite similar to that of the annual and monthly electronics spend. To support the argument that a higher income could motivate higher electronics spend, the correlation between the annual income and the monthly electronics spend and annual electronics spend was found. These both correspond to 0.361 (as the annual electronics spend was calculated by multiplying the monthly spend by 12). Hence, there is a weak positive correlation between electronics spend and annual income, telling us that although both variables tend to go up in response to one another, the relationship is not very strong. It is important to remember that correlation does not imply causation, and so we cannot conclude that an increasing income caused an increase in electronics spend.
...
### Additional Insights (Suggestions For TiVo on Target Segment)
...
# References
Hayden, L. (2018). PCA Analysis in R. Retrieved October 27, 2019, from https://www.datacamp.com/community/tutorials/pca-analysis-r.
